...
month_dict = {'A': 'All', 1: 'January', 2: 'February', 3: "March", 4: 'April', 5: 'May',
              6: 'June', 7: 'July', 8: 'August', 9: 'September', 10: 'October', 11: 'November',
              12: 'December'}
day_dict = {'A': 'All', 'M': 'Monday', 'TU': 'Tuesday', 'W': 'Wednesday', 'TH': 'Thursday', 'F': 'Friday',
    ...
    while choice == 'N':
        ...
        while city == '':
            answer = input('\nWhich city would you like to display data for? \n(Type "C" for Chicago, '
                           '"N" for New York City, or "W" for Washington): ').upper()
...
def load_data(city, month, day):
    ...
    if month != 'A':
        if month not in df_check:
            print('Sorry, there is no data for the month of {} in the city of {}. Data only exists for the following '
...
def time_stats(df, month, day):
    ...
    day_str = {0: 'Monday', 1: 'Tuesday', 2: 'Wednesday', 3: 'Thursday', 4: 'Friday', 5: 'Saturday', 6: 'Sunday'}
    ...
    if month != 'A':
        print('All data are from the month of {}'.format(month_dict[month].title()))
    else:
        month_mode = int(df['Month'].mode())
        print('The most common month for rentals is {}'.format(month_dict[month_mode].title()))
    ...
    hour_dict = {0: '12:00 AM', 1: '1:00 AM', 2: '2:00 AM', 3: '3:00 AM', 4: '4:00 AM', 5: '5:00 AM', 6: '6:00 AM',
    ...
    if hour_mode < 23:
        ...
        hour_end = 0
    print('The most common hour for rentals is between {} and {}'.format(hour_dict[hour_mode], hour_dict[hour_end]))
...
def trip_duration_stats(df, city):
    ...
    print('The total time traveled in {} for this period is {}.'.format(city.title(), total_time))

    # display mean travel time
    mean_time = df['duration'].mean()
    print('The average time traveled in {} for this period is {}.'.format(city.title(), mean_time))
...
def user_stats(df, city):
    ...
    for ut in user_types:
        ...
        print('The number of users who are {}s in {} is {}.'.format(ut.lower(), city.title(), user_df['Start Time'].count()))
    print('\n')
    ...
    try:
        ...
        for ug in user_gender:
            ...
            print('The number of users in {} who are {} is {}.'.format(city.title(), ug.lower(), user_df['Start Time'].count()))
    except (KeyError, NameError):
        print('There are no gender statistics for the city of {}.'.format(city.title()))
    ...
    try:
        ...
        print('\nThe earliest birth year for users in {} is {}.'.format(city.title(), birth_year_min))
        print('The most recent birth year for users in {} is {}.'.format(city.title(), birth_year_max))
        print('The most common birth year for user in {} is {}'.format(city.title(), birth_year_mode))
    except KeyError:
        print('\nThere are no birth year statistics for the city of {}.'.format(city.title()))
    print("\nThis took %s seconds." % (time.time() - start_time))
    print('-'*40)
